...
// Insert an item at the head. Test insert when empty, at beginning, end, and middle. Then test insert at same position you previously inserted at
  ...
  */
      if(list->size()==0){cout<<"SUCCESS, list is empty"<<endl;}
      else{cout<<"FAIL list is NOT empty"<<endl;}
      ...
      if(list->size()==8){cout<<"SUCCESS, list size is 8 from positions 0-7"<<endl;}
      else{cout<<"FAIL list is NOT 8"<<endl;}

      list->remove(5);
      if(list->size()==7){cout<<"SUCCESS, list size is 8 from positions 0-6"<<endl;}
      else{cout<<"FAIL list is NOT 7"<<endl;}
      
      list->remove(7);
      if(list->size()==7){cout<<"SUCCESS, no node removed"<<endl;}
      else{cout<<"FAIL list is NOT 7"<<endl;}
      ...
      if(list->size()==4){cout<<"SUCCESS, list size is 4"<<endl;}
      else{cout<<"FAIL list is NOT 4"<<endl;}
      ...
      if(list->size()==0){cout<<"SUCCESS, list size is 0"<<endl;}
      else{cout<<"FAIL list is NOT 0"<<endl;}
